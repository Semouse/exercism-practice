...
class SumOfMultiplesTest {
    ...
    @Test
    void testNoMultiplesWithinLimit() {
        int[] set = {3, 5};
    ...
    @Test
    void testOneFactorHasMultiplesWithinLimit() {
        int[] set = {3, 5};
    ...
    @Test
    void testMoreThanOneMultipleWithinLimit() {
        int[] set = {3};
    ...
    @Test
    void testMoreThanOneFactorWithMultiplesWithinLimit() {
        int[] set = {3, 5};
    ...
    @Test
    void testEachMultipleIsOnlyCountedOnce() {
        int[] set = {3, 5};
    ...
    @Test
    void testFactorsNotRelativelyPrime() {
        int[] set = {4, 6};
    ...
    @Test
    void testOneFactorIsAMultipleOfAnother() {
        int[] set = {5, 25};
    ...
    @Test
    void testAllNumbersAreMultiplesOf1() {
        int[] set = {1};
        int output = new SumOfMultiples(100, set).getSum();
    ...
    @Test
    void testNoFactorsMeanAnEmptySum() {
        int[] set = {};
        int output = new SumOfMultiples(10000, set).getSum();
        assertThat(output).isZero();
    }
    ...
    @Test
    void testSumOfMultiplesOfZeroIsZero() {
        int[] set = {0};
        int output = new SumOfMultiples(1, set).getSum();
        assertThat(output).isZero();
    }
    ...
    @Test
    void testFactorZeroDoesNotAffectTheSumOfMultiplesOfOtherFactors() {
        int[] set = {3, 0};
        int output = new SumOfMultiples(4, set).getSum();
        assertThat(output).isEqualTo(3);
    }
    ...
    @Test
    void testSolutionsUsingIncludeExcludeMustExtendToCardinalityGreater3() {
        int[] set = {2, 3, 5, 7, 11};
        int output = new SumOfMultiples(10000, set).getSum();
