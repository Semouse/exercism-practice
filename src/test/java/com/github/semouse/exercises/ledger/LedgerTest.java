...
class LedgerTest {
    ...
    @Test
    void multipleEntriesOnSameDateOrderedByDescription() {
        var entries = new Ledger.LedgerEntry[]{
    ...
    @Test
    void finalOrderTieBreakerIsChange() {
        var entries = new Ledger.LedgerEntry[]{
    ...
    @Test
    void dutchNegativeNumberWith3DigitsBeforeDecimalPoint() {
        var entries = new Ledger.LedgerEntry[]{
    ...
    @Test
    void americanNegativeNumberWith3DigitsBeforeDecimalPoint() {
        var entries = new Ledger.LedgerEntry[]{
                ledger.createLedgerEntry("2015-03-12", "Buy present", -12345)
        };
        String actual = ledger.format(USD_CURRENCY, US_LOCALE, entries);
